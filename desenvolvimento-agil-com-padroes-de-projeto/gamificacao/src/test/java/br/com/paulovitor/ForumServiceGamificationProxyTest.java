...
public class ForumServiceGamificationProxyTest {
    ...
    public void setUp() {
        ...
        memoryAchievementStorage.addObserver(new CreationPointsObserver(memoryAchievementStorage));
        memoryAchievementStorage.addObserver(new ParticipationPointsObserver(memoryAchievementStorage));
